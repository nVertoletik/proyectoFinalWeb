    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        ...
        include "config.php";
          ...
          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update-cart.php?action=empty" class="button alert">Vaciar Carrito</a>&nbsp;<a href="products.php" class="button [secondary success alert]">Continuar comprando</a>';
          if(isset($_SESSION['username'])) {
            echo '<a href="orders-update.php"><button style="float:right;">COD</button></a>';
          }

          else {
            echo '<a href="login.php"><button style="float:right;">Iniciar sesión</button></a>';
          }
