...
if(validarUsuario($nombre, $apellidoPaterno, $apellidoMaterno, $telefono, $correo, $password, $usuario)){
	$registro = "insert into prestashop_usuarios (nombre,apaterno,amaterno,telefono,correo,password,usuario) values('$nombre','$apellidoPaterno','$apellidoMaterno','$telefono','$correo', '$password', '$usuario')";
